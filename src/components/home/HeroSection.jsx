...
export default function HeroSection() {
  return (
    <section className="relative min-h-[92vh] md:min-h-screen flex items-center justify-center overflow-hidden">
      <div className="absolute inset-0" style={{ background: 'linear-gradient(145deg, #1a0a0c 0%, #99141e 45%, #7a1018 75%, #1a0a0c 100%)' }} />
      ...
      <div className="relative z-10 max-w-5xl mx-auto px-4 md:px-8 text-center py-24 md:py-0">
        <motion.div initial={{ opacity: 0, scale: 0.8 }} animate={{ opacity: 1, scale: 1 }} transition={{ duration: 0.8, ease: 'easeOut' }}>
          <img src={LOGO_URL} alt="شعار شركة إعفاء" className="w-24 h-24 md:w-32 md:h-32 object-contain mx-auto mb-8 rounded-3xl shadow-2xl" loading="eager" />
        </motion.div>
        ...
        <motion.div initial={{ opacity: 0, y: 40 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.8, delay: 0.2 }}>
          ...
          <h1 className="text-4xl md:text-6xl lg:text-7xl font-bold text-white mb-4 leading-tight">شركة إعفاء</h1>
          <p className="text-xl md:text-3xl font-medium mb-2" style={{ color: '#a97c50' }}>
