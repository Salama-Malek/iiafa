    ...
    <section className="py-20 md:py-28 pattern-overlay" style={{ background: 'var(--warm-gray)' }}>
      <div className="max-w-4xl mx-auto px-4 md:px-8 text-center">
        <motion.div initial={{ opacity: 0, y: 30 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.7 }}>
          ...
          <h2 className="text-3xl md:text-5xl font-bold mb-4" style={{ color: '#99141e' }}>{t('home.cta.title')}</h2>
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
            ...
            <Link to={createPageUrl('Contact')} className="inline-flex items-center gap-2 px-8 py-4 rounded-xl font-bold text-white text-lg transition-all hover:opacity-90 hover:scale-105" style={{ background: '#99141e' }}>
              {t('home.cta.form')}
