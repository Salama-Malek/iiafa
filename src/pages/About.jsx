...
export default function About() {
  return (
    <div>
      ...
      {/* About Content */}
      <section
        className="py-20 md:py-28 pattern-overlay"
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center mb-20">
            ...
            >
              ...
              <p className="text-gray-700 text-lg leading-loose mb-4">
                ...
                للمحاماة والاستشارات القانونية لتكون شريكك في النجاح بعون الله
                وتوفيقه.
              </p>
              <p className="text-gray-600 text-base leading-loose">
                نسعى من خلال تقديم خبراتنا واستشاراتنا القانونية لتحقيق أهداف
                عملائنا وخدمتهم بكل مهنية واحترافية، مستندين إلى قاعدة معرفية
                واسعة في مختلف فروع القانون السعودي.
              </p>
            </motion.div>
          </div>
